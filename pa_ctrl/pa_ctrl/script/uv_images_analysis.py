...
class image_converter:
  ...
  def __init__(self):
    ...
    rospy.wait_for_message("/camera/depth/image_rect_raw",Image,timeout=15)
  ...
  def drawBox(self, image_bin, img_og, resX, resY):
    ...
    rotated_rect_.center.x = biggest_rect[1][0]
    rotated_rect_.center.y = biggest_rect[1][1]
    rotated_rect_.size.height = biggest_rect[0][0]
